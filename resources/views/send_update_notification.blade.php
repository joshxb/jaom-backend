...
<head>
    <title>Update Notification - JAO Ministry</title>
    ...
    <div class="container">
        <div class="card">
            <div style="padding: 10px 30px">
                <div class="offer-detail-item" style="text-indent: 0">A new update has been posted a while ago, kindly check the details:</div>
                <div class="prayer-offer-text">
                    <div class="appreciation-message">
                        Subject: <b>{{ $user['subject'] }}</b>
                    </div>
                    <div class="appreciation-message">
